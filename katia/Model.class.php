...
class Paginas {
    ...
    public function Banner() {
        ...
        if (mysql_num_rows($banner) === 0) {
            echo "http://www.nossashistorias.com.br/templatesimages/categoria5/3/slide_padrao.jpg";
        }
        ...
        while ($res = mysql_fetch_array($galeria)) {
            ...
            echo "
                <div class='col-md-personalizado'>
                    <a href='http://www.nossashistorias.com.br/site/user/galeria/$this->url' data-lightbox='roadtrip'>
                        <img src='http://www.nossashistorias.com.br/site/user/galeria/$this->url' />
                    </a>
                </div>
                ";
        }
        ...
        while ($res = mysql_fetch_array($presentes)) {
            ...
            echo "
                <div class='col-md-personalizado1'> 
                    ...
                    <img src='http://www.nossashistorias.com.br/site/user/img-presentes/$this->url' alt='$this->nome' title='$this->nome' /></div>
                    <h2>$this->nome</h2>

...
class Paginas {
    ...
    public function Banner() {
        ...
        if (mysql_num_rows($banner) === 0) {
            echo "<img src='http://www.nossashistorias.com.br/templatesimages/categoria5/1/slide_padrao.jpg' alt='Cadastre o banner do seu evento' title='Cadastre o banner do seu evento'>";
        }
            ...
            echo "
                 <div>
                    <div class='left_full'>
                        ...
                        <div class='bgs'>
                            <div class='col-md-12'>
                                <img src='http://www.nossashistorias.com.br/user/img-presentes/$this->url' class='bg_thumb' alt='$this->nome' title='$this->nome' style='width:178px;height:166px;'/>
                                <p>$this->valor_final</p>
                                <div class='col-md-10'>
                                    <a href='lista-de-presentes-detalhes?id=$this->id' class='more_about'>» Presentear</a>
                                </div>
                            </div>
                        </div>
                    </div>

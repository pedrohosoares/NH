...
class Paginas {
    ...
    public function Banner() {
        ...
        if (mysql_num_rows($banner) === 0) {
            echo "<img src='http://www.nossashistorias.com.br/templatesimages/categoria1/1/slide_padrao.jpg' alt='Cadastre o banner do seu evento' title='Cadastre o banner do seu evento'>";
        }

        ...
        <div id="shadow_bg">
            <div id="main_container">
                ...
                <div id="center_container">
                    ...
                    <div class="content">
                        <div class="left_full">
                            <p>A nossa lista de presentes foi preparada com imagens ilustrativas (presente virtual). Vocês podem escolher uma das várias opções que, com muita dedicação, selecionamos. Com certeza, iremos adorar o presente! Esperamos vocês na festa!</p>
                        </div>
                    ...
                    <div class="pages_title">
                        <h2>Lista de <span>Presentes</span> em lojas físicas</h2>
                    </div> 

                    <div class="content">

                        <?php
                        $paginas->ListaPresentesLoja();
                        ?>

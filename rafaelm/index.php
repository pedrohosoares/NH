...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Great+Vibes' rel='stylesheet' type='text/css'/>
        ...
        <body class="single">
            ...
            <section id="love_story1" style="padding-bottom: 40px; padding-top: 40px; background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">
                <div class="container">

                    <!-- .section_title_wrap -->
                    <div class="section_title_wrap">
                        <h1 class="section_title">
                            <span style="background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">Sobre o <b>Evento</b></span>
                        </h1>
            ...
            <section id="love_story1" style="padding-bottom: 40px; padding-top: 40px; background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">
                <div class="container">
                    ...
                    <div class="section_title_wrap">
                        <h1 class="section_title">
                            <span style="background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">Homenagens</span>
                        </h1>
                        <p class="section-text">
        ...
        <section id="important_people"  style="    padding-top: 40px; padding-bottom: 40px; background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1;">
            <div class="container">

                <!-- .section_title_wrap -->
                <div class="section_title_wrap">
                    <h1 class="section_title">
                        <span style="background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">Mensagem dos <b>Convidados</b></span>
                    </h1>
        ...
        <!-- <section id="gallery" style="    padding-top: 40px;">
            ...
            <section id="blog"  style="    padding-top: 40px; padding-bottom: 40px; background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">
                <div class="container">
                    <div class="section_title_wrap">
                        <h1 class="section_title">
                            <span style="background: url(http://www.nossashistorias.com.br/templatesimages/bg-nossas-historias.png)#C2EBF1">Lista de <b>Presentes</b></span>

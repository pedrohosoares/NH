...
<body>
    ...
    <div class="about_content" style="background: #F7D1E8">
        <div class="full_width_centered">
            <!--<h2>SOBRE O EVENTO</h2>-->
            <div class="left_full">
                <!-- <p style="text-align: center;">
                    <h2 style='text-align: initial; text-transform: uppercase;'><strong class='color-strong'><strong>Festa</strong></h2>
    ...
    <div class="about_content">
        <div class="full_width_centered">
            <h2>MINHAS <strong class="color-strong">HISTÓRIAS</strong></h2>
            <div class="left_full">
                <p style="text-align: center;">
    ...
    <div class="about_content" style="background: #F7D1E8">
        <div class="full_width_centered">
            <h2><strong class="color-strong">HOMENAGEADOS</strong></h2>
            <div class="left_full">
                <p style="text-align: center;">

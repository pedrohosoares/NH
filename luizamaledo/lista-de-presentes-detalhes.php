...
require_once('../../user/model/Pagamento/Pagamento.class.php');
$paginas = New Paginas();
?>
<!DOCTYPE html>
                    ...
                    <div class="content">
                        ...
                        <div class='right full' style=" margin-right: 20px;float: right;;width: 50%; ">
                            <div class="form_content">
                                ...
                                <br/>
                                <p>Indique seu próprio CEP, na compra do presente no Moip.</p>
                                ...
                                if (isset($_POST['acao-presente'])) {
                                    $pagamento->setDadosPost($_POST);                                               
                                    $pagamento->geraIdUnico();
                                    $pagamento->geraIdUnicoProduto();
                                    $pagamento->iniciaMoip($db);
                                    $pagamento->setaComprador();
                                    $pagamento->setProduto('Vale produto NH em dinheiro');
                                    $pagamento->setaProdutoCompra();
                                    $resposta = $pagamento->realizaPagamento($db);
                                }  
                                if(isset($resposta)){
                                    if(is_array($resposta)){
                                        echo "Código do boleto:<br /><h3>".$resposta[1]."</h3>";
                                        echo "<a href='".$resposta[0]."' download class='pagar'>Baixar Boleto</a><br /><br /><br />"; 
                                    }else{
                                        echo "<h3>Pagamento efetivado com sucesso!</h3>";
                                    }
                                }

    ...
    <body>
        ...
        <div class="home_bottom background-home-bottom">
            <div class="full_width_centered">
                <p class="left_full">A nossa lista de presentes foi preparada com imagens ilustrativas (presente virtual). Vocês podem escolher uma das várias opções que, com muita dedicação, selecionamos. Com certeza, iremos adorar o presente! Esperamos vocês na festa!</p>
                ...
                <?php $paginas->ListaPresentesLoja($db); ?>

        ...
        <div id="shadow_bg">
            <div id="main_container">
                ...
                <div id="center_container">
                    ...
                    <div class="content">
                        <div class="left_full">
                            <p>A minha lista de presentes foi preparada com imagens ilustrativas (presente virtual). Você pode escolher uma das várias opções que, com muita dedicação, selecionei. Com certeza, irei adorar o seu presente! Espero você na festa!</p>
                        </div>

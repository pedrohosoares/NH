...
<html xmlns="http://www.w3.org/1999/xhtml" lang="pt-br" xml:lang="pt-br">
    ...
    <body class="single">
        ...
        <!-- #important_people -->
        <section id="important_people"  style="    padding-top: 40px;">
            <div class="container">

                <!-- .section_title_wrap -->
                <div class="section_title_wrap">
                    <h1 class="section_title">
                        <span>Envie sua <b>Mensagem</b></span>
                    </h1>
                    <p class="section-text">
                        <div class="rsvp_wrap">
                ...
                <div class="section_title_wrap">
                    <h1 class="section_title">
                        <span>Mensagem dos <b>Convidados</b></span>
                    </h1>
        ...
        <section id="blog"  style="    padding-top: 40px;">
            <div class="container">
                <div class="section_title_wrap">
                    <h1 class="section_title">
                        <span>Lista de <b>Presentes</b></span>

                    </h1>
                    <p class="section-text">A minha lista de presentes foi preparada com imagens ilustrativas (presente virtual). Você pode escolher uma das várias opções que, com muita dedicação, selecionei. Com certeza, irei adorar o seu presente! Espero você na festa!</p>
                </div>
                <div class="row">
                ...
                <div class="section_title_wrap">
                    <h1 class="section_title">
                        <span>Lista de <b>Presentes</b> em lojas físicas</span>

...
class Paginas {
    ...
    public function Banner() {
        ...
        if (mysql_num_rows($banner) === 0) {
            echo "http://www.nossashistorias.com.br/templatesimages/categoria2/2/slide_padrao.jpg";
        }
    ...
    public function SobreEvento() {
        ...
        echo "
            <h3><strong>Localização da Cerimônia</strong></h3>
            ...
            <h3><strong>Localização da Festa</strong></h3>
        ...
        while ($res = mysql_fetch_array($mural)) {
            ...
            echo "
                <div class='left_full'>
                    <h3>$this->nome</h3>
                    <p class='texto-justificado'>$this->texto</p>
                    <p class='small'>Data Postada: $this->data_cadastro_nova</p>
                </div>
                ";
        }
    }
                    ...
                    <div class='row'>
                        <div class='single_blog_post blog-responsivo col-lg-12 col-md-12 col-sm-12'>
                            <div class='image-wrap'>
                                <img src='http://www.nossashistorias.com.br/user/img-presentes/$this->url' alt=''>
                                    <div class='overlay'></div>
                            </div>
                            <h2>$this->nome</h2>
                            <label>$this->valor_final</label>
                            <a href='lista-presentes-detalhes?id=$this->id' class='readmore'>Presentear</a>
                        </div>
                    </div>
                </div>
                ";
    ...
    public function ListaPresentesDetalhes() {
        ...
        if ($this->id === 'vale-presente') {
            ...
            <div class='bgs'>
                ...
                <div class='clear'></div>
                <div class='col-md-6'>
                    <p class='price'>Informe o valor no formulário</p>
                </div>
                </div>
            </div>
            ";
            ...
            <div class='bgs'>
                ...
                <div class='clear'></div>
                <div class='col-md-6'>
                    <p class='price'>$this->valor_final</p>
                </div>
                </div>
            </div>
            ";
            ...
            echo "
                <div class='col-lg-personalizado col-md-3 col-sm-3 wow slideInLeft' data-wow-duration='500'>
                    <div class='row'>
                        <div class='single_blog_post blog-responsivo col-lg-12 col-md-12 col-sm-12'>
                            <div class='image-wrap'>
                                <img src='http://www.nossashistorias.com.br/templatesimages/vale-presente-templates.jpg' alt=''>
                                    <div class='overlay'></div>
                            </div>
                            <h2>Vale-Presente</h2>
                            <label>Informe o valor</label>
                            <a href='lista-presentes-detalhes?id=vale-presente'' class='readmore'>Presentear</a>
                        </div>
                    </div>
                </div>
                ";

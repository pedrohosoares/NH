...
class Paginas {
    ...
    public function DataHorario($db) {
        ...
        echo "
            <div class='center' id='venue'>
                <div class='date'>Data: $this->data_evento_nova</div>
                <div class='time'>Horário: <span>$this->horario_evento</span></div>
            </div>
            ";
    }
    ...
    public function Banner($db) {
        ...
        if ($banner->num_rows === 0) {
            echo "<img src='http://www.nossashistorias.com.br/templatesimages/categoria5/4/slide_padrao.jpg' width='785' height='289' alt='Cadastre o banner do seu evento' title='Cadastre o banner do seu evento'>";
        }
        if ($banner->num_rows === 1) {
            echo "<img src='http://www.nossashistorias.com.br/user/bannerprincipal/$this->url' width='785' height='289' alt='Imagem do Casamento' title='Imagem do Casamento'>";
        }
    }
    ...
    public function InstagramIndex($db) {
        ...
        echo "<iframe src='http://widget.websta.me/in/tag:$this->url/?r=1&w=4&h=1&b=1&p=5' allowtransparency='true' frameborder='0' scrolling='no' style='border:none;overflow:hidden;width:400px; height:140px' ></iframe>";
    }
    ...
    public function SobreEvento($db) {
        ...
        echo "
            ...
            <h3 class='center-h3'><strong class='strong-h3'>Localização da Festa</strong></h3>
    ...
    public function GaleriaFotos($db) {
        ...
        while ($res = $galeria->fetch_array()) {
            ...
            echo "
                <li class='swing'>
                    <a href='http://www.nossashistorias.com.br/user/galeria/$this->url' rel='prettyPhoto[gallery]' class='viewDetail lightbox'>
    ...
    public function RSVP($db) {
        ...
        if ($this->tipo_festa === 'ambos') {
            ...
            $insert = $db->query("INSERT INTO etb_lista_convidados_religioso 
                values(
                null,
                '$this->id_evento', 
                '$this->nome', 
            ...
            $insert = $db->query("INSERT INTO etb_lista_convidados_festa 
                values(
                null,
                '$this->id_evento', 
                '$this->nome', 
        ...
        while ($res = $presentes->fetch_array()) {
            ...
            echo "
                <div class='col-md-personalizado'>
                    <div class='accordion'>
                        <div class='acc'>
                            <img src='http://www.nossashistorias.com.br/user/img-presentes/$this->url' width='226' height='160'/>
                            <p class='nome-presente'>$this->nome</p>
                            <p>$this->valor_final</p>
                            <a href='lista-de-presentes-detalhes?id=$this->id' class='botao-compra'>Presentear</a>
                        </div>
                    </div>
                </div>
                ";
        ...
        if ($this->id === 'vale-presente') {
            echo "
                <div class='col-md-personalizado'>
                    <div class='accordion'>
                        <div class='acc'>
                            <img src='http://www.nossashistorias.com.br/templatesimages/vale-presente-templates.jpg' width='226' height='160'/>
                            <p class='nome-presente'>Vale-Presente</p>
    ...
    public function ValePresente($db) {
        ...
        if ($status == '1') {
            ...
            echo "
                <div class='col-md-personalizado margin-to-top'>
                    <div class='accordion'>
                        <div class='acc'>
                            <img src='http://www.nossashistorias.com.br/templatesimages/vale-presente-templates.jpg' width='226' height='160'/>
                            <p class='nome-presente'>Vale-Presente</p>
                            <p>Informe o valor</p>
                            <a href='lista-de-presentes-detalhes?id=vale-presente' class='botao-compra'>Presentear</a>
                        </div>
                    </div>
                </div>
                ";

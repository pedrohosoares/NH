    ...
    <body>
        ...
        <div class="about_content">
            <div class="full_width_centered" style="padding: 0">
                <div class="left_full">
                    <p style="text-align: center; margin-top: 50px;">Ficamos muito felizes que vocês estejam confirmando as suas presenças na nossa festa. Esperamos vocês para comemorarmos juntos! Um grande abraço!</p>
                </div>
                    ...
                    <div class="full_width_centered"  style="padding: 0">
                        ...
                        <div class="form_content">
                            ...
                            <form id="ContactForm" method="post" action="" onsubmit="return validaRSVP(this);">
                                ...
                                <h3 class="form_subtitle">Confirmar Presença</h3>

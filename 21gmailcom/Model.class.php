...
class Paginas {
    ...
    public function Banner($db) {
        ...
        if ($banner->num_rows === 0) {
            echo '<img src="http://www.'.str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/templatesimages/categoria4/3/slide_padrao.jpg".'"/>'; 
        }
        if ($banner->num_rows === 1) {
            echo '<img src="http://www.'.str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/bannerprincipal/$this->url".'"/>';
        }
    }
    ...
    public function GaleriaFotos($db) {
        ...
        while ($res = $galeria->fetch_array()) {
            ...
            <a href='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/galeria/$this->url' data-lightbox='roadtrip'>
            <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/galeria/$this->url' />
            </a>
            </div>
            ";
        }
    ...
    public function ListaPresentes($db) {
        ...
        while ($res = $presentes->fetch_array()) {
            ...
            echo "
            <div class='col-md-personalizado1 borda-presentes' style='width: 280px; float: left; margin-left: 50px; margin-top: 15px;'> 
             <div class='bottom_icon'>
            <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/img-presentes/$this->url' alt='$this->nome' title='$this->nome' /></div>
            <h2>$this->nome</h2>
    ...
    public function ListaPresentesDetalhes($db) {
        if(isset($_GET['id'])){
            ...
            if ($this->id === 'vale-presente') {
                ...
                <div class='bottom_icon'>
                <img src='".'http://www.'.str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/templatesimages/vale-presente-templates.jpg' alt='Vale-Presente' title='Vale-Presente' /></div>
                <h2>Vale-Presente</h2>
    ...
    public function ValePresente($db) {
        ...
        if ($status == '1') {
            ...
            echo "
            <div class='col-md-personalizado1' style='width: 280px; float: left; margin-left: 50px; margin-top: 15px;'> 
            <div class='bottom_icon'>
            <img src='".'http://www.'.str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/templatesimages/vale-presente-templates.jpg' alt='Vale-Presente' title='Vale-Presente' /></div>
            <h2>Vale-Presente</h2>

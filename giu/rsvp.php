    ...
    <body>
        ...
        <div class="about_content" style="background: #F7D1E8">
            <div class="full_width_centered" style="padding: 0">
                <div class="left_full">
                    <p style="text-align: center;margin-top: 50px;">Fico muito feliz que vocês estejam confirmando as suas presenças na minha festa. Espero vocês para comemorarmos juntos! Um grande abraço!</p>
                </div>

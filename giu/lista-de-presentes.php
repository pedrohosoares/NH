    ...
    <body>
        ...
        <div class="home_bottom background-home-bottom">
            <div class="full_width_centered">
                <p class="left_full" style="background: #F7D1E8; padding-top: 40px;">A minha lista de presentes foi preparada com imagens ilustrativas (presente virtual). Vocês podem escolher uma das várias opções que, com muita dedicação, selecionei. Com certeza, irei adorar o presente! Espero vocês na festa!</p>

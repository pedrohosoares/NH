...
class Paginas {
    ...
    public function Banner($db) {
        ...
        if ($banner->num_rows === 0) {
            echo 'http://www.'.str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/templatesimages/categoria4/1/slide_padrao.jpg";
        }
        if ($banner->num_rows === 1) {
            echo 'http://www.'.str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/bannerprincipal/$this->url";
        }
    }
    ...
    public function GaleriaFotos($db) {
        ...
        while ($res = $galeria->fetch_array()) {
            ...
            <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."templatesimages/categoria1/1/gallery_frame.png' alt='' title='' border='0' class='frame' />
            <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/galeria/$this->url' alt='' title='' border='0' class='thumb' />
            <span class='portfolio_caption'>
            <a href='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/galeria/$this->url' rel='prettyPhoto[gallery]'>
            <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."templatesimages/categoria1/1/zoom.png' alt='' title='' border='0' />
            </a>
            </span>
            </li>
            ";
        ...
        while ($res = $presentes->fetch_array()) {
            ...
            <div class='col-md-personalizado1 borda-presentes'> 
                <div class='bottom_icon'>
                    <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/img-presentes/$this->url' alt='$this->nome' title='$this->nome'>
                </div>
                <h2>$this->nome</h2>
    ...
    public function ListaPresentesDetalhes($db) {
        if(isset($_GET['id'])){
            ...
            if ($this->id === 'vale-presente') {
                ...
                <div class='bgs'>
                <div class='col-md-12'>
                <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/templatesimages/vale-presente-templates.jpg' class='bg_thumb' alt='Vale-Presente' title='Vale-Presente' style='width:166px;height:166px;'/>
                </div>
                <div class='clear'></div>
                <div class='col-md-6'>
                ...
                <div class='bgs'>
                <div class='col-md-12'>
                <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/user/img-presentes/$this->url' class='bg_thumb' alt='$this->nome' title='$this->nome' style='width:166px;height:166px;'/>
                </div>
                <div class='clear'></div>
                <div class='col-md-6'>
    ...
    public function ValePresente($db) {
        ...
        if ($status == '1') {
            ...
            <div class='col-md-personalizado1 borda-presentes'> 
                <div class='bottom_icon'>
                    <img src='http://www.".str_replace(array('http://','www.','https://'),'',$_SERVER['SERVER_NAME'])."/templatesimages/vale-presente-templates.jpg' alt='Vale-Presente' title='Vale-Presente'>
                </div>
                <h2>Vale-Presente</h2>

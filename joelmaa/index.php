...
<head>
  <title><?php $paginas->Title($db); ?> | Página Inicial</title>
...
<body>
  ...
  <div class="about_content" style="background-color: #F7D29A !important">
    <div class="full_width_centered">
      <div class='caixas-homenageados'>
        <span class="swirl_left">
          <span class="swirl_right">
            <h2 style="padding-bottom: 0px; margin-bottom: 0px;">MINHAS HISTÓRIAS</h2>
          </span>
        </span>
        <p><?php $paginas->SobreEventoIndex($db); ?></p>
